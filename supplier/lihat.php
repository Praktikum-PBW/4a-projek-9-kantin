...
<h2>Lihat Data Supplier</h2>
    <div class="col">
        <div class="row mt-5">
        <form class="form-input" method="POST">
        <div class="mb-3">
                <label for="id_supplier" class="form-label">Id Supplier</label>
                <input type="text" name="id_supplier" value="<?php echo $r['id_supplier']?>" class="form-control" readonly>
            </div>
            <div class="mb-3">
                <label for="nama_supplier" class="form-label">Name</label>
                <input type="text" name="nama_supplier" value="<?php echo $r['nama_supplier']?>" class="form-control" readonly>
            </div>
            <div class="mb-3">
                <label for="jk_supplier" class="form-label">Jenis Kelamin</label>
                <select name="jk_supplier" id="jk_supplier" class="form-select" disabled>
